            ...
            <div class="row">
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 mb15">
                        <div class="form-group">
                            <label class="control-label col-lg-4">Air Port Link in GM</label>

                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="airport_link" value="{{$data->airport_link}}">
                            </div>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box">
                            <div id="cleditorDiv" class="body collapse in">
                                <textarea name="description" id="cleditor" class="form-control" required>{!! $data->description !!}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-lg-12">
                        <hr>
                    <button type="submit" class="btn btn-success pull-left"> <i class="fa fa-save"></i> Save Change</button>
                    </div>
                </form>
            </div>
