            ...
            <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            @foreach($cities as $item)
                                    <option value="{{$item->code}}" @if($ticket->from == $item->code) selected @endif>{{$item->name}} ({{$item->code}})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <select name="to" data-placeholder="Select Arrival" class="form-control chzn-select" tabindex="2" required>
                                <option value=""></option>
                                @foreach($cities as $item)
                                    <option value="{{$item->code}}" @if($ticket->to == $item->code) selected @endif>{{$item->name}} ({{$item->code}})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-9">
                            <select name="flight" data-placeholder="Select Airline" class="form-control chzn-select" tabindex="2" required>
                                ...
                                @foreach($airlines as $item)
                                    <option value="{{$item->code}}" @if($ticket->flight == $item->code) selected @endif>{{$item->name}} ({{$item->code}})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="flight_no" class="form-control" type="text" data-mask="999" value="{{$ticket->flight_no}}" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <select name="route_type" data-placeholder="Route Type" id="routeselector" class="form-control chzn-select" tabindex="2">
                                <option value=""></option>
                                <option value="0" @if($ticket->route_type == '0') selected @endif>Non Stop</option>
                                <option value="1"  @if($ticket->route_type == '1') selected @endif>One Stop</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group stop" id="1">
                        ...
                        <div class="col-lg-9">
                            <select name="via" data-placeholder="Select Airport" class="form-control chzn-select" tabindex="2">
                                <option value=""></option>
                                @foreach($cities as $item)
                                    <option value="{{$item->code}}"  @if($ticket->via == $item->code) selected @endif>{{$item->name}} ({{$item->code}})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-lg-12 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                        <input type="text" name="adates" value="@foreach(unserialize($ticket->adates) as $date){{$date}}@if(!$loop->last),@endif @endforeach" class="form-control date" id="date" required/>
                        </div>
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-lg-6 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="dep" class="form-control" type="text" data-mask="99:99" value="{{$ticket->dep}}" required/>
                ...
                <div class="col-lg-6 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="eta" class="form-control" type="text" data-mask="99:99" value="{{$ticket->eta}}" required/>
                                <span class="input-group-addon">Time</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <select name="tm_cat" data-placeholder="Time Category" class="form-control chzn-select" tabindex="2" required>
                                <option value=""></option>
                                <option value="Morning" @if($ticket->tm_cat == "Morning") selected @endif>Morning Flight</option>
                                <option value="Afternoon" @if($ticket->tm_cat == "Afternoon") selected @endif>Afternoon Flight</option>
                                <option value="Evening" @if($ticket->tm_cat == "Evening") selected @endif>Evening Flight</option>
                                <option value="Night" @if($ticket->tm_cat == "Night") selected @endif>Night Flight</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="duration" class="form-control" type="text" data-mask="99 hr 99 min" value="{{$ticket->duration}}" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <select name="words" data-placeholder="Available Seat" class="form-control chzn-select" tabindex="2" required>
                                <option value=""></option>
                                <option value="all" @if($ticket->words == "all") selected @endif>all</option>
                                @for($x=1;$x<7;$x++)
                                <option value="{{$x}} seat left" @if($ticket->words == $x." seat left") selected @endif>{{$x}} seat left</option>
                                    @endfor
                                <option value="promotion seat" @if($ticket->words == "promotion seat") selected @endif>promotion seat</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="clearfix"></div>
                    <div class="col-lg-4 mb15">
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input name="saver_fare_usd" value="{{$ticket->saver_fare_usd}}" class="form-control" type="number" required/>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="saver_fare_child_usd" value="{{$ticket->saver_fare_child_usd}}" class="form-control" type="number" required/>
                                <span class="input-group-addon">USD</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="saver_fare_infant_usd" value="{{$ticket->saver_fare_infant_usd}}" class="form-control" type="number" required/>
                                <span class="input-group-addon">USD</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="saver_fare_mm" value="{{$ticket->saver_fare_mm}}" class="form-control" type="number" required/>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="saver_fare_child_mm" value="{{$ticket->saver_fare_child_mm}}" class="form-control" type="number" required/>
                                <span class="input-group-addon">MMK</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="saver_fare_infant_mm" value="{{$ticket->saver_fare_infant_mm}}" class="form-control" type="number" required/>
                                <span class="input-group-addon">MMK</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="plus_fare_usd" value="{{$ticket->plus_fare_usd}}" class="form-control" type="number" required/>
                                <span class="input-group-addon">USD</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="plus_fare_child_usd" value="{{$ticket->plus_fare_child_usd}}" class="form-control" type="number" required/>
                                <span class="input-group-addon">USD</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="plus_fare_infant_usd" value="{{$ticket->plus_fare_infant_usd}}" class="form-control" type="number" required/>
                                <span class="input-group-addon">USD</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="plus_fare_mm" value="{{$ticket->plus_fare_mm}}" class="form-control" type="number" required/>
                                <span class="input-group-addon">MMK</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="plus_fare_child_mm" value="{{$ticket->plus_fare_child_mm}}" class="form-control" type="number" required/>
                                <span class="input-group-addon">MMK</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb15">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="plus_fare_infant_mm" value="{{$ticket->plus_fare_infant_mm}}" class="form-control" type="number" required/>
                                <span class="input-group-addon">MMK</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <label class="control-label col-lg-12">Set Policy</label>
                                        <div class="box">
                                            <div id="cleditorDiv" class="body collapse in">
                                                <textarea name="policy" id="cleditor" class="form-control" required>{!! $ticket->policy !!}</textarea>
                                            </div>
                                        </div>
                    </div>
                <div class="clearfix"></div>
                <div class="col-lg-12">
                    <div class="form-group">
                        <button type="submit" class="btn btn-success col-lg-12">Edit Ticket</button>
                    </div>
                </div>
            </div>
