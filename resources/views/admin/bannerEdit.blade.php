                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="first_word" class="form-control" value="{{$banner->first_word}}" required/>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <label for="">Second Word</label>
                            <input type="text" name="second_word" class="form-control" value="{{$banner->second_word}}" required/>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <label for="">Connect Page</label>
                            <select name="page_id" data-placeholder="Select Pages" class="form-control chzn-select" tabindex="2" required>
                                <option value=""></option>
                                @foreach($page as $item)
                                    <option value="{{$item->id}}" @if($item->id == $banner->page_id) selected @endif>{{$item->title}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <label for="">Background Image (HD)</label>
                            <input type="file" name="img">
                            <br>
                            <small>selected | {{$banner->img}}</small>
                        </div>
                    </div>
