            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                        <label for="">Main Page Title</label>
                        <input type="text" name="title" class="form-control" value="{{$keyword->title}}" required/>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                       <label for="">Keywords</label>
                       <input name="keywords" id="tags" value="{{$keyword->keywords}}" class="form-control" required/>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                        <label for="">Meta Description</label>
                        <textarea name="description" id="" cols="30" rows="3" class="form-control" required>{{$keyword->description}}</textarea>
                    </div>
                </div>
            </div>
            <hr>
