            ...
            <div class="row">
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 mb15">
                        <hr>
                        <div class="form-group">
                            <label class="control-label col-lg-9">Selected Airline Logo</label>
                            <div class="col-lg-3">
                    ...
                    <div class="col-lg-12 mb15">
                        <hr>
                        <div class="form-group">
                            <label class="control-label col-lg-9">Selected Airline Gallery </label>
                            <div class="col-lg-3">
                                <input name="img[]" type="file" required multiple>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
