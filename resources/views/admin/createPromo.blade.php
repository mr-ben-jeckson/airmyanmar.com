            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="flights[]" data-placeholder="Choose Flights"  class="form-control chzn-select" multiple="multiple" tabindex="4" style="height:25px;">
                            @foreach($data as $item)
                                <option value="{{$item->id}}">{{$item->flight}}-{{$item->flight_no}} {{$item->from}}-{{$item->to}} {{$item->dep}} - {{$item->eta}} @if($item->via) via ({{$item->via}})@endif</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="keys" placeholder="XXXXXXXX" required>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input name="fare_off_mm" class="form-control" type="number" required/>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        <label for="">Save Per Person</label>
                        <div class="input-group">
                            <input name="fare_off_usd" class="form-control" type="number" required/>
