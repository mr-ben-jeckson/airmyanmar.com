                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="travel_date" id="dp3" class="form-control" placeholder="MM/DD/YYYY" data-date-format="mm/dd/yyyy" required/>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <label for="">Customer Profile (OPTIONAL)</label>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="radio" name="points" value="1"> <i class="fa fa-star"></i>
                            <input type="radio" name="points" value="2"> <i class="fa fa-star"></i> <i class="fa fa-star"></i>
                            <input type="radio" name="points" value="3"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i>
                            <input type="radio" name="points" value="4"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i>
                            <input type="radio" name="points" value="5"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-lg-12 col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <hr>
                        <button type="submit" class="btn btn-primary pull-right"> <i class="fa fa-save"></i> Add Now </button>
                    </div>
                </div>
            </div>
            </form>
