            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                       ...
                       <input name="keywords" id="tags" class="form-control" required/>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                        <label for="">Meta Description</label>
                        <textarea name="meta_description" id="" cols="30" rows="3" class="form-control" placeholder="meta description" required></textarea>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12">
