                ...
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 mb15">
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="airport_link">
                            </div>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box">
                            <div id="cleditorDiv" class="body collapse in">
                                <textarea name="description" id="cleditor" class="form-control" required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-lg-12">
                        <hr>
                    <button type="submit" class="btn btn-success pull-left"> <i class="fa fa-save"></i> Add New </button>
                    </div>
                </form>
            </div>
