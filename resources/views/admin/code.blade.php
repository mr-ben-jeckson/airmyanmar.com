            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                        <label for="">Insert Code Between Head Tag in Web App</label>
                        <textarea name="head" id="" cols="30" rows="10" class="form-control">{!! $data->head !!}</textarea>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                        <label for="">Insert Code Near Body End Tag in Web App</label>
                        <textarea name="body" id="" cols="30" rows="10" class="form-control">{!! $data->body !!}</textarea>
                    </div>
                </div>
            </div>
            <hr>
