            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="col-lg-12 mb15">
                        <h4><i class="fa fa-plane"></i> Flight Search Section</h4>
                        <hr>
                    </div>
                            ...
                            <div class="col-lg-9">
                                <select name="from" data-placeholder="Select Origin" class="form-control chzn-select" tabindex="2" required>
                                    ...
                                    @foreach($cities as $item)
                                        <option value="{{$item->code}}" @if($request->from == $item->code) selected @endif>{{$item->name}} ({{$item->code}})</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select name="to" data-placeholder="Select Arrival" class="form-control chzn-select" tabindex="2" required>
                                    <option value=""></option>
                                    @foreach($cities as $item)
                                        <option value="{{$item->code}}" @if($request->to == $item->code) selected @endif>{{$item->name}} ({{$item->code}})</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-9">
                                <select name="flight" data-placeholder="Select Airline" class="form-control chzn-select" tabindex="2">
                                    ...
                                    @foreach($airlines as $item)
                                        <option value="{{$item->code}}" @if(!$request->flight == null && $request->flight == $item->code) selected @endif>{{$item->name}} ({{$item->code}})</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select name="tm_cat" data-placeholder="Time Category" class="form-control chzn-select" tabindex="2">
                                    <option value=""></option>
                                    <option value="Morning" @if(!$request->tm_cat == null && $request->tm_cat == "Morning") selected @endif>Morning Flight</option>
                                    <option value="Afternoon" @if(!$request->tm_cat == null && $request->tm_cat == "Afternoon") selected @endif>Afternoon Flight</option>
                                    <option value="Evening" @if(!$request->tm_cat == null && $request->tm_cat == "Evening") selected @endif>Evening Flight</option>
                                    <option value="Night" @if(!$request->tm_cat == null && $request->tm_cat == "Night") selected @endif>Night Flight</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <a href="{{url('/admin/flights/search')}}" class="btn btn-default btn-line pull-right">Back </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
                </form>
                    <div class="col-lg-12">
                        <div class="col-lg-12">
                    <hr>
                    <h4> <i class="fa fa-filter"></i> Search Results : {{count($tickets)}}</h4>
                            <hr>
                        </div>
                </div>
                    <div class="col-lg-12 mb15">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <table class="table table-responsive table-hover">
                                                ...
                                                <tr>
                                                    <td><h4>$ {{$item->saver_fare_usd}}</h4></td>
                                                    <td><h4>$ {{$item->saver_fare_child_usd}}</h4></td>
                                                    <td><h4>$ {{$item->saver_fare_infant_usd}}</h4></td>
                                                </tr>
                                                <tr>
                                            ...
                                            <table class="table table-responsive table-hover">
                                                ...
                                                <tr>
                                                    <td><h4>$ {{$item->plus_fare_usd}}</h4></td>
                                                    <td><h4>$ {{$item->plus_fare_child_usd}}</h4></td>
                                                    <td><h4>$ {{$item->plus_fare_infant_usd}}</h4></td>
                                                </tr>
                                                <tr>
