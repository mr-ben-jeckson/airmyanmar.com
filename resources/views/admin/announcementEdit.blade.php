                ...
                <div class="col-lg-12 col-md-12">
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Announcement" value="{{$data->name}}" required>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="validate" class="form-control" id="reportrange" value="{{$data->validate}}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_description" value="{{$data->meta_description}}" class="form-control" required>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-lg-12 col-md-12">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <select name="status" data-placeholder="Select Status" class="form-control chzn-select" tabindex="2" required>
                                ...
                                <option value="0" @if($data->status == 2) selected @endif>Hide</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <label for="">Photo ({{$data->img}} selected)</label>
                            <input type="file" name="img">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                        <button type="submit" class="btn btn-primary form-control"> <i class="fa fa-save"></i> Update Now </button>
                        </div>
                    </div>
                </div>
                </form>
