                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <table class="table table-hover table-responsive">
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('/admin/page/delete/'.$item->id)}}" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a> <a href="{{url('/admin/page/edit/'.$item->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a> <a href="{{url('/admin/page/view/'.$item->id)}}" class="btn btn-warning btn-xs"><i class="fa fa-eye"></i></a></td>
                            <td>
                                <div class="make-switch switch-mini">
                                    <input type="checkbox" @if($item->status == 1)checked="checked" onchange="window.location.href='{{url('/admin/page/hide/'.$item->id)}}'" @else onchange="window.location.href='{{url('/admin/page/show/'.$item->id)}}'" @endif  />
                                </div>
                            </td>
                        </tr>
                        @endforeach
