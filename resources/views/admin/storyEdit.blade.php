            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Story Title" value="{{$data->title}}" required/>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        <label for="">Author Name</label>
                        <input type="text" name="name" class="form-control" placeholder="Author Name" value="{{$data->name}}" required/>
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                       ...
                       <input name="keywords" id="tags" value="{{$data->keywords}}" class="form-control" required/>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                        <label for="">Meta Description</label>
                        <textarea name="description" id="" cols="30" rows="3" class="form-control" required>{{$data->description}}</textarea>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        <label class="">Photo (<small>{{$data->img}} selected</small>)</label>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        ...
                        <select name="status" id="" class="form-control" required>
                            ...
                            <option value="1" @if($data->status == 1) selected @endif>Published / Show </option>
                            <option value="0" @if($data->status == 0) selected @endif>Unpublished / Hide </option>
                        </select>
                    </div>
                </div>
            </div>
