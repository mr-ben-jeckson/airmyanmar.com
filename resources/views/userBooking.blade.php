...
@section('title') {{$user->name}}'s Booking @stop
@section('content')
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">{{$user->name}}'s Booking</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 side-bar right-side-bar" style="padding-top: 0;">
                        ...
                        <div class="row booking-text-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="booking_id" placeholder="Enter Booking ID">
                            </div>
                                <div class="form-group">
                                    <label for="">Search by Travel Date</label>
                                    <input type="text" class="form-control" id="date" name="dep_date" placeholder="Search by Departed Date" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label for="">Search by Booking Date</label>
                                    <input type="text" class="form-control" id="date1" name="booking_date" placeholder="Search by Booking Date" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="status" id="" class="form-control">
                                        ...
                                        <option value="2">Awaiting Payment List</option>
                                        <option value="3">Complete List</option>
                                        <option value="4">Final Completed List</option>
