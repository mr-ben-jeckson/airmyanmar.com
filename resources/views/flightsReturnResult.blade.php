            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">({{session('return_from')}}) to ({{session('return_to')}})</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
            ...
            <div class="container">
                <div class="row">
                                    ...
                                    <div class="modal-dialog animated zoomInLeft">
                                        <div class="modal-content">
                                            <div class="modal-header mtb air-m-h">
                                                ...
                                                <h5 class="modal-title">{{$flight->name}} - {{$flight->flight}} {{$flight->flight_no}} | Economy Saver Fare Details | Returned Flight Total Calculation</h5>
                                            </div>
                                            <div class="modal-body">
                                                <div class="col-md-12">
                                                    <p>
                                            ...
                                            <div class="modal-footer air-m-h" style="position: fixed; bottom: 0; width: 100%;">
                                                <form action="{{url('/selected/round-trip')}}" method="get" enctype="multipart/form-data">
                                                    {{csrf_field()}}
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    <input type="hidden" name="flight[]" value="{{session('dep_flight')}}">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="grid-block main-block f-grid-block">
                                                ...
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">@if($nation == '2') MMK {{$flight->saver_fare_mm}} <br>@else USD {{$flight->saver_fare_usd}}@endif<span class="divider">|</span><span class="pkg"><small>@if($flight->route_type == 0) non-stop @else 1 stop ({{$flight->via}}) @endif</span></small></li>
                                                </ul>
                                    ...
                                    @if(!$flight->saver_fare_usd == 0 && !$flight->saver_fare_mm == 0)
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="grid-block main-block f-grid-block">
                                                ...
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">@if($nation == '2') MMK {{$flight->saver_fare_mm}} <br>@else USD {{$flight->saver_fare_usd}}@endif<span class="divider">|</span><span class="pkg">@if($flight->route_type == 0) non-stop @else 1 stop ({{$flight->via}}) @endif</span></li>
                                                </ul>
                                    ...
                                    @if(!$flight->plus_fare_usd == 0 && !$flight->plus_fare_mm == 0)
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="grid-block main-block f-grid-block">
                                                ...
                                                <ul class="list-unstyled list-inline offer-price-1"> 
                                                    <li class="price">@if($nation == '2') MMK {{$flight->plus_fare_mm}}
                                                        <br> @else USD {{$flight->plus_fare_usd}}@endif<span class="divider">|</span><span class="pkg">@if($flight->route_type == 0) non-stop @else 1 stop ({{$flight->via}}) @endif</span></li>
                                                </ul>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 side-bar right-side-bar filter-box">
                        ...
                        <div class="row">
                            <form action="{{url('/selected/dep-flight')}}" method="get" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <input type="hidden" name="flight" value="{{session('dep_flight')}}">
                                <input type="hidden" name="date" value="{{session('dep_date')}}">
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <span style="font-weight: bold; font-size: larger; color: #ac0072;" class="text-center"><hr> <i class="fa fa-search"></i> Modify Returned Flights<hr></span>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="tm_cat" id="" class="form-control">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="from" class="form-control" id="origin" disabled>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="to" class="form-control" id="origin" disabled>
                                            @foreach($sector as $item)
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <div class="form-group">
                                        <label for="checkdate">Departed Date</label>
                                        <input type="text" name="dep_date" id="checkdate" class="form-control dpd1" value="{{session('dep_date')}}" readonly>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <div class="form-group">
                                        <label for="checkdate">Returned Date</label>
                                        <input type="text" name="return_date" id="checkdate" class="form-control dpd1" value="{{session('return_date')}}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <div class="form-group">
                                    ...
                                    <div class="row" style="margin-bottom: 15px;">
                                        <div class="col-xs-4 pull-left">
                                            ...
                                            <input name="adult" type="number" class="form-control" value="{{session('adult')}}" readonly>
                                        </div>
                                        <div class="col-xs-4 pull-left">
                                            <label for="" class="small">Child</label>
                                            <input name="child" type="number" class="form-control"  value="{{session('child')}}" readonly>
                                        </div>
                                        <div class="col-xs-4 pull-left">
                                            <label for="" class="small">Infant</label>
                                            <input name="infant" type="number" class="form-control" value="{{session('infant')}}" readonly>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="nation" id="nation" class="form-control" disabled>
