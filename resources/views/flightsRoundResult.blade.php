...
@section('description')Myanmar Flights Center - Best Flight Deals and Get Cheap Flights From {{$from->name}} to {{$to->name}}, From {{$to}} to {{$from}} @stop
@section('markup')
                                    ...
                                    <div class="modal-dialog animated zoomInLeft">
                                        <div class="modal-content">
                                            <div class="modal-header mtb air-m-h">
                                                ...
                                                <h5 class="modal-title">{{$flight->name}} - {{$flight->flight}} {{$flight->flight_no}} | Economy Saver Fare Details | Departed Flight Total Calculation</h5>
                                            </div>
                                            <div class="modal-body">
                                                <div class="col-md-12">
                                                    <p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="dep_date" id="checkdate" class="form-control dpd1" value="{{$date}}">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-12">
                                <div class="form-group">
                                    <label for="checkdate">Return Date</label>
