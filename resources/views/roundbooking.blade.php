...
@section('content')
    ...
    <div class="container-fluid process-container">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-8">
                @if(count($discount) == 0)
                <form action="{{url('/selected/round-trip')}}" method="get" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="col-md-4" style="margin-bottom: 15px;">
                    <input type="text" name="coupon" placeholder="Type Coupon" class="form-control" required="" />
                        {{csrf_field()}}
                        <input type="hidden" name="flight[]" id="flight1" value="">
                        <input type="hidden" name="flight[]" id="flight2" value="">
                        <input type="hidden" name="class" value="{{session('return_class')}}">
                    </div>
               ...
               <div class="clearfix"></div>
                    ...
                    <div class="col-md-12 mb15">
                            {{csrf_field()}}
                        @foreach(range(1,session('adult')) as $x)
                            <div class="row">
                            @if(session('adult') > 1)<span class="flight-passenger-title"><i class="fa fa-user"></i> Passenger {{$x}}</span>@else <span class="flight-passenger-title"><i class="fa fa-user"></i> Passenger</span> @endif
                                <hr>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">@if(session('nation') == 1)Passport @else NRC Number @endif</label>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select class="form-control" name="nationality[]" required="">
                                        ...
                                        <option value="Myanmar" @if(session('nation') == 2) selected @endif>Myanmar</option>
                    ...
                    <div class="col-md-12 mb15">
                        @if(!session('child') == 0)
                        @foreach(range(1,session('child')) as $x)
                            <div class="row">
                                @if(session('child') > 1)<span class="flight-passenger-title">Passenger <span class="small">(Child)</span> {{$x}}</span> @else <span class="flight-passenger-title">Passenger <span class="small">(Child)</span></span> @endif
                                <hr>
                                <div class="col-md-6 form-group">
                                    <label for="">Title</label>
                                    <select class="form-control" name="title[]" required="">
                    ...
                    <div class="col-md-12 mb15">
                        @if(!session('infant') == 0)
                            @foreach(range(1,session('infant')) as $x)
                                <div class="row">
                                    @if(session('infant') > 1)<span class="flight-passenger-title">Passenger <span class="small">(Infant)</span> {{$x}}</span> @else <span class="flight-passenger-title">Passenger <span class="small">(Infant)</span></span> @endif
                                    <hr>
                                    <div class="col-md-6 form-group">
                                        <label for="">Title</label>
                                        <select class="form-control" name="title[]" required="">
                    ...
                    <div class="col-md-12 ">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="hidden" name="class" value="{{session('class')}}">
                                <input type="hidden" name="return_class" value="{{session('return_class')}}">
                                <input type="hidden" name="nation" value="{{session('nation')}}">
                                <input type="hidden" name="ticket[]" id="flight1" value="{{$request->flight[0]}}">
                                <input type="hidden" name="ticket[]" id="flight2" value="{{$request->flight[1]}}">
                                <input type="hidden" name="route" id="route">
                                <input type="hidden" name="dep" value="{{session('dep_date')}}">
            ...
            <div class="col-md-4">
                ...
                <div class="row booking-text">
                    ...
                    <div class="col-xs-6">{{$Dflight->from}} <i class="fa fa-arrow-right"></i> {{$Dflight->to}} </div>
                    <div class="col-xs-6">Air line</div>
                    <div class="col-xs-6">{{$Dairline->name}}</div>
                    <div class="col-xs-6">Flight No.</div>
                    <div class="col-xs-6">{{$Dflight->flight}} {{$Dflight->flight_no}}</div>
                    <div class="col-xs-6">TAKE OFF</div>
                    <div class="col-xs-6">ETD {{$Dflight->dep}} - {{session('dep_date')}}</div>
                    <div class="col-xs-6">LANDING</div>
                    <div class="col-xs-6">ETA {{$Dflight->eta}}- {{session('dep_date')}}</div>
                </div>
                <div class="row passenger-detail-badge">
                    Returned Flight Detail
                </div>
                <div class="row booking-text">
                    <div class="col-xs-6">Flying Route</div>
                    <div class="col-xs-6">{{$Rflight->from}} <i class="fa fa-arrow-right"></i> {{$Rflight->to}} </div>
                    <div class="col-xs-6">Air line</div>
                    <div class="col-xs-6">{{$Rairline->name}}</div>
                    <div class="col-xs-6">Flight No.</div>
                    <div class="col-xs-6">{{$Rflight->flight}} {{$Rflight->flight_no}}</div>
                    <div class="col-xs-6">TAKE OFF</div>
                    <div class="col-xs-6">ETD {{$Rflight->dep}} -  {{session('return_date')}}</div>
                    <div class="col-xs-6">LANDING</div>
                    <div class="col-xs-6">ETA {{$Rflight->eta}} -  {{session('return_date')}}</div>
                </div>
                ...
                <div class="row booking-text-2">
                    ...
                    <div class="col-xs-6">{{session('adult')}}</div>
                    <div class="col-xs-6">Child</div>
                    <div class="col-xs-6">{{session('child')}}</div>
                    <div class="col-xs-6">Infant</div>
                    <div class="col-xs-6">{{session('infant')}}</div>
                    <div class="col-xs-6">Total Passenger</div>
                    <div class="col-xs-6">{{session('adult') + session('child') + session('infant')}}</div>
                </div>
                <div class="row passenger-detail-badge-2">
                    Fare Detail
                </div>
...
@section('script')
    ...
    @endif
    <script type="text/javascript">
            document.getElementById('flight1').value = '{{$request->flight[0]}}';
            document.getElementById('flight2').value = '{{$request->flight[1]}}';
    ...
    <script>
        document.getElementById('route').value = 'round';
