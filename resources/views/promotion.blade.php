...
@section('description'){{$data->meta_description}}@stop
@section('facebook_markup')
    <meta property="og:url"                content="{{url('/flights/seasonal-promotions/'.$data->slug)}}" />
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="space-right">
                            ...
                            <div class="blog-post">
                                <div class="main-img blog-post-img">
                                    <img src="{{url('/images/'.$data->img)}}" class="img-responsive" alt="blog-post-image">
                                ...
                                <div class="blog-post-detail pk-bg">
                                    <b><i class="fa fa-calendar"></i> Validate - {{$data->validate}}</b> | <b><i class="fa fa-globe"></i> Published - {{$data->created_at->format('d D, M, Y - G:i:s')}}</b>
                                </div>
                            </div><!-- end blog-post -->
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 side-bar right-side-bar" style="padding-top: 0;">
                        ...
                        <a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//airmyanmar.com/flights/seasonal-promotions/{{$data->slug}}" class="btn btn-block btn-pink"> Share on Facebook </a>
                        <br>
                        <a href="{{url('/flights-seasonal-promotions')}}" class="btn btn-block btn-pink">View All Promotions </a>
                    </div><!-- end columns -->
